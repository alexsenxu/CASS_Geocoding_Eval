 ...
 * 
 */
public class CASS2GeocoderBing5k {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            File input=new File("NATLSTG1_withkey_bing_from050001.txt");
            if (!input.exists()) {
            ...
            File output=new File("NATLSTG1_withkey_bingGeocoded_from050001.txt");
...
//                    }
            ...
            Logger.getLogger(CASS2GeocoderBing5k.class.getName()).log(Level.SEVERE, null, ex);
        }
